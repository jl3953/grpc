 ...
 public:
   ...
   public:
    ...
    class experimental_async_interface {
     public:
      ...
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void GetFeature(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::routeguide::Feature* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void GetFeature(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::routeguide::Feature* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      // A server-to-client streaming RPC.
      //
      // Obtains the Features available within the given Rectangle.  Results are
   ...
   public:
    ...
    class experimental_async final :
     ...
     public:
      ...
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void GetFeature(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::routeguide::Feature* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void GetFeature(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::routeguide::Feature* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
  ...
  class ExperimentalWithCallbackMethod_GetFeature : public BaseClass {
   ...
   public:
    ExperimentalWithCallbackMethod_GetFeature() {
      ...
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(0,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::routeguide::Point, ::routeguide::Feature>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
    ...
    #endif
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::routeguide::Point, ::routeguide::Feature>*>(handler)
    ...
    ExperimentalWithCallbackMethod_ListFeatures() {
      ...
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(1,
          new ::grpc_impl::internal::CallbackServerStreamingHandler< ::routeguide::Rectangle, ::routeguide::Feature>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
                   ::grpc::CallbackServerContext*
    #else
    ...
    ExperimentalWithCallbackMethod_RecordRoute() {
      ...
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(2,
          new ::grpc_impl::internal::CallbackClientStreamingHandler< ::routeguide::Point, ::routeguide::RouteSummary>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
                   ::grpc::CallbackServerContext*
    #else
    ...
    ExperimentalWithCallbackMethod_RouteChat() {
      ...
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(3,
          new ::grpc_impl::internal::CallbackBidiHandler< ::routeguide::RouteNote, ::routeguide::RouteNote>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
                   ::grpc::CallbackServerContext*
    #else
